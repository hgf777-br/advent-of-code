...
def find_item_value(data, line, line_number):
    part_number = None
    part = None
    sum_part_numbers = 0
    for item in line:
        if item[0].isnumeric():
            part_number = item
            if part:
                if part_number[1] == part[2]:
                    sum_part_numbers += int(part_number[0])
        else:
            part = item
            if line_number > 0:
                for part_number_up in data[line_number - 1]:
                    ...
                    if part_number_up[0].isnumeric() and (
                        ...
                        sum_part_numbers += int(part_number_up[0])
                        # break
            if line_number < len(data) - 1:
                for part_number_down in data[line_number + 1]:
                    ...
                    if part_number_down[0].isnumeric() and (
                        ...
                        sum_part_numbers += int(part_number_down[0])
                        # break
            if part_number and part[1] == part_number[2]:
                sum_part_numbers += int(part_number[0])

    print(line_number, sum_part_numbers)
...
for line_number, line in enumerate(data):
    total += find_item_value(data, line, line_number)
